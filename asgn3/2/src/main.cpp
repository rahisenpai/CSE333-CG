...
int main(int, char**)
{
    ...
    unsigned int shaderProgram = createProgram("./shaders/gouraud/vshader.vs", "./shaders/gouraud/fshader.fs");
    // unsigned int shaderProgram = createProgram("./shaders/phong/vshader.vs", "./shaders/phong/fshader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lpos_world_uniform, 100.0, 100.0, 100.0);
