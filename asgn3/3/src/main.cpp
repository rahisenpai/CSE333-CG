...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(spotlightDir_uniform, -0.4f, -0.7f, -1.0f);
        glUniform1f(cutOff_uniform, glm::cos(glm::radians(21.0f)));
        glUniform1f(inCutOff_uniform, glm::cos(glm::radians(20.0f)));
